...
![read the file with Notepad++](Scrolling_through_the_file.png)
...
![This line looks sort of out of place](OutOfPlaceString.png)
...
Let's go to base64decode.org and decode this string.
![decoding the string at base64decode.org](decoding_the_string.png)
