...
![Curl to PaulWeb](Curl to PaulWeb.png)
![Navigating directory & launching Nano](Creating the JWK.JSON file.png)
![Using Nano to save the public key in jwks.json](Using Nano to save the public key in jwks.json.png)
